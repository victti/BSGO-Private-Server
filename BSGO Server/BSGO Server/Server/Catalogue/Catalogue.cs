...
namespace BSGO_Server
{
    internal static class Catalogue
    {
        ...
        public static void SetupCards()
        {
            ...
            mk7Stats.Add(ObjectStat.DurabilityBonus, 9000);
            ...
            mapStar.Add(0, new MapStarDesc(0, new Vector2(-302.0f, 233.8f), 0, Faction.Neutral, 0, 0, 163231265, false, false, false, false));
            mapStar.Add(1, new MapStarDesc(1, new Vector2(-218.1f, 217.0f), 0, Faction.Neutral, 2, 255, 163231266, false, false, false, false));
            mapStar.Add(2, new MapStarDesc(2, new Vector2(-157.0f, 241.5f), 1, Faction.Neutral, 5, 5, 163231267, false, false, false, false));
            mapStar.Add(3, new MapStarDesc(3, new Vector2(59.0f, 230.8f), 1, Faction.Neutral, 8, 8, 163231268, false, false, false, false));
            mapStar.Add(4, new MapStarDesc(4, new Vector2(173.7f, 198.9f), 1, Faction.Neutral, 5, 5, 163231269, false, false, false, false));
            mapStar.Add(5, new MapStarDesc(5, new Vector2(254.9f, 211.0f), 1, Faction.Neutral, 255, 2, 163231270, false, false, false, false));
            mapStar.Add(6, new MapStarDesc(6, new Vector2(317.0f, 209.0f), 0, Faction.Neutral, 0, 0, 163231271, false, false, false, false));
            mapStar.Add(7, new MapStarDesc(7, new Vector2(-354.5f, 160.8f), 0, Faction.Neutral, 3, 255, 163231272, false, false, false, false));
            mapStar.Add(8, new MapStarDesc(8, new Vector2(-271.1f, 159.9f), 1, Faction.Neutral, 4, 255, 163231273, false, false, false, false));
            mapStar.Add(9, new MapStarDesc(9, new Vector2(-40.0f, 231.4f), 1, Faction.Neutral, 8, 8, 163231274, false, false, false, false));
            mapStar.Add(10, new MapStarDesc(10, new Vector2(8.1f, 192.3f), 0, Faction.Neutral, 13, 13, 195781329, false, false, false, false));
            mapStar.Add(11, new MapStarDesc(11, new Vector2(99.6f, 174.0f), 0, Faction.Neutral, 7, 7, 195781330, false, false, false, false));
            mapStar.Add(12, new MapStarDesc(12, new Vector2(293.2f, 154.0f), 0, Faction.Neutral, 255, 4, 195781331, false, false, false, false));
            mapStar.Add(13, new MapStarDesc(13, new Vector2(360.8f, 132.7f), 1, Faction.Neutral, 255, 3, 195781332, false, false, false, false));
            mapStar.Add(14, new MapStarDesc(14, new Vector2(-104.1f, 210.4f), 1, Faction.Neutral, 6, 6, 195781333, false, false, false, false));
            mapStar.Add(15, new MapStarDesc(15, new Vector2(-299.0f, 94.8f), 0, Faction.Neutral, 9, 9, 195781334, false, false, false, false));
            mapStar.Add(16, new MapStarDesc(16, new Vector2(-80.9f, 153.3f), 1, Faction.Neutral, 12, 12, 195781335, false, false, false, false));
            mapStar.Add(17, new MapStarDesc(17, new Vector2(-126.9f, 103.8f), 1, Faction.Neutral, 15, 15, 195781336, false, false, false, false));
            mapStar.Add(18, new MapStarDesc(18, new Vector2(134.0f, 124.1f), 1, Faction.Neutral, 12, 12, 195781337, false, false, false, false));
            mapStar.Add(19, new MapStarDesc(19, new Vector2(265.0f, 84.4f), 1, Faction.Neutral, 9, 9, 195781338, false, false, false, false));
            mapStar.Add(20, new MapStarDesc(20, new Vector2(218.2f, 150.0f), 1, Faction.Neutral, 6, 6, 1957811313, false, false, false, false));
            mapStar.Add(21, new MapStarDesc(21, new Vector2(-379.8f, 92.2f), 1, Faction.Neutral, 10, 10, 1957811314, false, false, false, false));
            mapStar.Add(22, new MapStarDesc(22, new Vector2(-194.1f, 149.5f), 0, Faction.Neutral, 11, 11, 1957811315, false, false, false, false));
            mapStar.Add(23, new MapStarDesc(23, new Vector2(-222.3f, 69.7f), 0, Faction.Neutral, 16, 16, 1957811316, false, false, false, false));
            mapStar.Add(24, new MapStarDesc(24, new Vector2(6.6f, 133.8f), 0, Faction.Neutral, 19, 19, 1957811317, false, false, false, false));
            mapStar.Add(25, new MapStarDesc(25, new Vector2(134.0f, 34.8f), 0, Faction.Neutral, 16, 16, 1957811318, false, false, false, false));
            mapStar.Add(26, new MapStarDesc(26, new Vector2(197.0f, 64.6f), 0, Faction.Neutral, 13, 13, 1957811319, false, false, false, false));
            mapStar.Add(27, new MapStarDesc(27, new Vector2(344.8f, 75.7f), 0, Faction.Neutral, 10, 10, 1957811320, false, false, false, false));
            mapStar.Add(28, new MapStarDesc(28, new Vector2(-298.3f, 28.9f), 0, Faction.Neutral, 14, 14, 1957811321, false, false, false, false));
            mapStar.Add(29, new MapStarDesc(29, new Vector2(-298.0f, -51.8f), 1, Faction.Neutral, 17, 17, 1957811322, false, false, false, false));
            mapStar.Add(30, new MapStarDesc(30, new Vector2(-195.0f, 4.2f), 1, Faction.Neutral, 20, 20, 195781361, false, false, false, false));
            mapStar.Add(31, new MapStarDesc(31, new Vector2(74.0f, 54.6f), 1, Faction.Neutral, 20, 20, 195781362, false, false, false, false));
            mapStar.Add(32, new MapStarDesc(32, new Vector2(169.3f, -14.0f), 1, Faction.Neutral, 20, 20, 195781363, false, false, false, false));
            mapStar.Add(33, new MapStarDesc(33, new Vector2(306.4f, -46.8f), 0, Faction.Neutral, 17, 17, 195781364, false, false, false, false));
            mapStar.Add(34, new MapStarDesc(34, new Vector2(268.2f, 13.9f), 0, Faction.Neutral, 14, 14, 195781365, false, false, false, false));
            mapStar.Add(35, new MapStarDesc(35, new Vector2(-243.1f, -108.1f), 1, Faction.Neutral, 18, 18, 195781366, false, false, false, false));
            mapStar.Add(36, new MapStarDesc(36, new Vector2(-200.5f, -54.5f), 0, Faction.Neutral, 20, 20, 195781367, false, false, false, false));
            mapStar.Add(37, new MapStarDesc(37, new Vector2(-69.5f, 58.8f), 0, Faction.Neutral, 20, 20, 195781368, false, false, false, false));
            mapStar.Add(38, new MapStarDesc(38, new Vector2(64.9f, -106.4f), 1, Faction.Neutral, 20, 20, 195781369, false, false, false, false));
            mapStar.Add(39, new MapStarDesc(39, new Vector2(96.6f, -43.9f), 0, Faction.Neutral, 20, 20, 195781370, false, false, false, false));
            mapStar.Add(40, new MapStarDesc(40, new Vector2(156.7f, -82.9f), 1, Faction.Neutral, 20, 20, 195781345, false, false, false, false));
            mapStar.Add(41, new MapStarDesc(41, new Vector2(243.4f, -89.1f), 0, Faction.Neutral, 18, 18, 195781346, false, false, false, false));
            mapStar.Add(42, new MapStarDesc(42, new Vector2(-120.4f, -142.8f), 1, Faction.Neutral, 20, 20, 195781347, false, false, false, false));
            mapStar.Add(43, new MapStarDesc(43, new Vector2(-113.5f, 6.2f), 1, Faction.Neutral, 20, 20, 195781348, false, false, false, false));
            mapStar.Add(44, new MapStarDesc(44, new Vector2(-133.2f, -66.6f), 1, Faction.Neutral, 20, 20, 195781349, false, false, false, false));
            mapStar.Add(45, new MapStarDesc(45, new Vector2(-68.2f, -201.8f), 0, Faction.Neutral, 20, 20, 195781350, false, false, false, false));
            mapStar.Add(46, new MapStarDesc(46, new Vector2(7.3f, -165.2f), 1, Faction.Neutral, 20, 20, 195781351, false, false, false, false));
            mapStar.Add(47, new MapStarDesc(47, new Vector2(90.8f, -186.2f), 1, Faction.Neutral, 20, 20, 195781352, false, false, false, false));
            mapStar.Add(48, new MapStarDesc(48, new Vector2(176.2f, -159.8f), 1, Faction.Neutral, 20, 20, 195781353, false, false, false, false));
            mapStar.Add(49, new MapStarDesc(49, new Vector2(-364.2f, 4.7f), 0, Faction.Neutral, 0, 0, 195781354, false, false, false, false));
            mapStar.Add(50, new MapStarDesc(50, new Vector2(342.4f, 5.5f), 0, Faction.Neutral, 0, 0, 195781137, false, false, false, false));
            mapStar.Add(51, new MapStarDesc(51, new Vector2(-194.0f, -173.0f), 0, Faction.Neutral, 20, 20, 195781138, false, false, false, false));
            mapStar.Add(52, new MapStarDesc(52, new Vector2(249.0f, -164.0f), 0, Faction.Neutral, 20, 20, 195781139, false, false, false, false));
            mapStar.Add(53, new MapStarDesc(110, new Vector2(-354.0f, 214.0f), 0, Faction.Neutral, 6, 255, 179711473, false, false, false, false));
            mapStar.Add(54, new MapStarDesc(111, new Vector2(364.0f, 184.0f), 1, Faction.Neutral, 255, 6, 179711474, false, false, false, false));
            mapStar.Add(55, new MapStarDesc(112, new Vector2(-46.0f, 109.0f), 0, Faction.Neutral, 115, 115, 179711475, false, false, false, false));
            mapStar.Add(56, new MapStarDesc(113, new Vector2(6.0f, 37.0f), 0, Faction.Neutral, 120, 120, 179711476, false, false, false, false));
            mapStar.Add(57, new MapStarDesc(114, new Vector2(60.0f, 106.0f), 0, Faction.Neutral, 115, 115, 179711477, false, false, false, false));
